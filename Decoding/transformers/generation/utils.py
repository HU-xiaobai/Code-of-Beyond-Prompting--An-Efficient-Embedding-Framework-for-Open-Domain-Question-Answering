...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        #print(f"Before calling super().generate, model_kwargs: {kwargs}")
        ...
        if generation_mode == GenerationMode.ASSISTED_GENERATION:
            ...
            #model_kwargs['ground_truth'] = ground_truth #zhanghao
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(
            ...
            outputs = self(
                **model_inputs,
                return_dict=True,
                ground_truth=model_kwargs['ground_truth'], #zhanghao
            )
